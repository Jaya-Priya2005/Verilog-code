...
//module adder_full_dataflow(input [0:2]d,
//     output [0:1]y );
...
//module adder_full_behavioral(input [0:2]d, output reg [0:1]y);
//always@(*)begin 
//case(d)
//3'b000 :y = 2'b00;
//3'b001 :y = 2'b10;
